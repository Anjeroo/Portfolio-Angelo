    ...
    return(
        <div id="aboutDiv">
            ...
            <div id="experience">
              ...
              <div className="works">
                <h2 className="workTitle"><img src="/src/assets/confianca.png" className="workIcon" />Confiança Supermercados
                  | 6 meses</h2>
                <h3 className="function">Operador de Loja</h3>
              </div>
              <div className="works">
                <h2 className="workTitle"><img src="src/assets/concilig.jpg" className="workIcon" />Concilig | 3 meses</h2>
                <h3 className="function">Operador de Telemarketing</h3>
              </div>
              <div className="works">
                <h2 className="workTitle"><img src="src/assets/arteskan.jpeg" className="workIcon" />ArtesKan | 6 meses</h2>
