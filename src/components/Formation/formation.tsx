                ...
                <div id="formationDiv">
                    ...
                    <ul id="boll">
                        <li className="text">
                            <div id="college">
                                <div className="schoolDiv">
                                    <img className="schoolImg" src="src/assets/unicesumar.jpg" />
                        ...
                        <li className="text">
                            <div id="school">
                                <div className="schoolDiv">
                                    <img className="schoolImg" src="src/assets/etec.jpeg" />
                ...
                <div id="certificate">
                    <div className="certificate">
                        <div>
                            ...
                            <img className="certificates" src="/src/assets/CertificadoAlura.jpg" alt="Certificado Alura" />
                    ...
                    <div className="certificate">
                        <div>
                            <h2>HTML e CSS</h2>
                            <img className="certificates" src="/src/assets/CertificadoDNC.jpg" />
                    ...
                    <div className="certificate">
                        <div>
                            ...
                            <img className="certificates" src="/src/assets/CertificadoAprenDaJavaScriptEm7Dias.jpg" />
